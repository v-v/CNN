...
if __name__ == "__main__":
	...
	convLayer1   = layerFM(50, 42, 42)
	poolLayer2   = layerFM(50, 21, 21)
	convLayer3   = layerFM(70, 18, 18)
	poolLayer4   = layerFM(70, 9, 9)
	convLayer5   = layerFM(80, 6, 6)
	poolLayer6   = layerFM(80, 3, 3)
	convLayer7   = layerFM(100, 1, 1)
	hiddenLayer8 = layer1D(100)
	outputLayer9 = layer1D(12, isOutput = True)

	convolution01  = convolutionalConnection(inputLayer0, convLayer1, np.ones([3, 50]), 7, 7, 1, 1)	
	pooling12      = poolingConnection(convLayer1, poolLayer2, 2, 2)
	convolution23  = convolutionalConnection(poolLayer2, convLayer3, np.ones([50, 70]), 4, 4, 1, 1)	
	pooling34      = poolingConnection(convLayer3, poolLayer4, 2, 2)
	convolution45  = convolutionalConnection(poolLayer4, convLayer5, np.ones([70, 80]), 4, 4, 1, 1)
	pooling56      = poolingConnection(convLayer5, poolLayer6, 2, 2)
	convolution67  = convolutionalConnection(poolLayer6, convLayer7, np.ones([80, 100]), 3, 3, 1, 1)
