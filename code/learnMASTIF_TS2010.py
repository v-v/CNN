...
if __name__ == "__main__":
	...
	convLayer1   = layerFM(25, 42, 42)
	poolLayer2   = layerFM(25, 21, 21)
	convLayer3   = layerFM(50, 18, 18)
	poolLayer4   = layerFM(50, 9, 9)
	convLayer5   = layerFM(60, 6, 6)
	poolLayer6   = layerFM(60, 3, 3)
	convLayer7   = layerFM(100, 1, 1)
	hiddenLayer8 = layer1D(80)
	outputLayer9 = layer1D(12, isOutput = True)

	convolution01  = convolutionalConnection(inputLayer0, convLayer1, np.ones([3, 25]), 7, 7, 1, 1)	
	pooling12      = poolingConnection(convLayer1, poolLayer2, 2, 2)
	convolution23  = convolutionalConnection(poolLayer2, convLayer3, np.ones([25, 50]), 4, 4, 1, 1)	
	pooling34      = poolingConnection(convLayer3, poolLayer4, 2, 2)
	convolution45  = convolutionalConnection(poolLayer4, convLayer5, np.ones([50, 60]), 4, 4, 1, 1)
	pooling56      = poolingConnection(convLayer5, poolLayer6, 2, 2)
	convolution67  = convolutionalConnection(poolLayer6, convLayer7, np.ones([60, 100]), 3, 3, 1, 1)
